...
function About() {
  ...
  return (
    <div className="min-h-screen bg-secondary-50 dark:bg-secondary-900">
      ...
      <section className="py-16 bg-white dark:bg-secondary-800">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-primary-50 dark:bg-primary-900 p-4 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">
                <FaHandshake className="w-8 h-8 text-primary-600" />
              </div>
              <h3 className="text-xl font-semibold mb-4 dark:text-white">Accessibility</h3>
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-4 dark:text-white">Security</h3>
              <p className="text-secondary-600 dark:text-secondary-400">
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-4 dark:text-white">Global Reach</h3>
              <p className="text-secondary-600 dark:text-secondary-400">
      ...
      {/* Team Section */}
      <section className="py-16 dark:bg-secondary-900">
        <div className="container">
      ...
      <section className="py-16 bg-white dark:bg-secondary-800">
        <div className="container">
          <h2 className="text-3xl font-bold text-center mb-12 dark:text-white">Supported Cryptocurrencies</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            {partners.map((partner, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-semibold dark:text-white">{partner.name}</h3>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 dark:bg-secondary-900">
        <div className="container">
          <h2 className="text-3xl font-bold text-center mb-12 dark:text-white">Recognition & Achievements</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2 dark:text-white">Best Blockchain Innovation</h3>
              <p className="text-secondary-600 dark:text-secondary-400">Real Estate Tech Awards 2024</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2 dark:text-white">Fastest Growing PropTech</h3>
              <p className="text-secondary-600 dark:text-secondary-400">Forbes Innovation 2024</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2 dark:text-white">Most Secure Platform</h3>
              <p className="text-secondary-600 dark:text-secondary-400">Blockchain Security Excellence 2024</p>
            </motion.div>
          </div>
        </div>
      </section>
